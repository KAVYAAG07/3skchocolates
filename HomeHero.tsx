      ...
      <section className="relative overflow-hidden py-16 lg:py-28 border-b border-gold-900/10">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center space-y-8">
          ...
          <p className="text-gray-400 text-base sm:text-lg max-w-2xl mx-auto font-light leading-relaxed">
            Handcrafted in small batches using premium toasted shred-kunafa pastry, rich pistachio cream, and roasted hazelnut praline—all locked inside a decadent, glossy milk chocolate shell. We package each bar with insulated cold-chains and deliver them in pristine condition <strong>all over India</strong>.
          </p>
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-4 pt-2">
            <button
              ...
              id="hero-order-cta"
              className="w-full sm:w-auto bg-gradient-to-r from-gold-600 via-gold-500 to-gold-600 text-dark-chocolate hover:from-gold-500 hover:to-gold-400 px-8 py-4 rounded text-base font-bold tracking-wider hover:shadow-lg hover:shadow-gold-500/25 transition-all duration-300 flex items-center justify-center gap-2 group cursor-pointer"
            >
              EXPLORE FLAVOURS
            ...
            <button
              ...
              id="hero-custom-cta"
              className="w-full sm:w-auto border border-gold-600/30 text-gold-300 hover:text-gold-100 hover:bg-gold-950/20 px-8 py-4 rounded text-base font-semibold tracking-wider transition-all duration-300 cursor-pointer"
            >
              CUSTOM WRAPPERS
            </button>
          </div>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          <div className="space-y-8">
            ...
            <div className="space-y-6 text-gray-400 font-light text-sm sm:text-base leading-relaxed max-w-3xl mx-auto">
              ...
              <p>
                When we explored the market, we noticed that high-quality Kunafa Chocolates were often sold at exceptionally high prices, making them a luxury that many chocolate lovers could not enjoy regularly. We believed that exceptional taste, premium ingredients, and world-class craftsmanship should never come at an unreasonable cost. That belief became the foundation of our journey.
              </p>
              <p>
                Based in Jaipur, Rajasthan, we set out to redefine the Indian Kunafa Chocolate market by offering the finest quality at the most competitive prices across the country. Every chocolate we create reflects our commitment to excellence—from the carefully selected premium chocolate and authentic fillings to the flawless shape, elegant finish, and consistent quality in every piece.
              </p>
              <p>
                Our mission is clear: to deliver the highest quality Kunafa Chocolates at the most affordable prices in India. We never compromise on ingredients, craftsmanship, or customer satisfaction. Every batch is crafted with precision to ensure a luxurious taste experience that rivals the finest premium brands.
              </p>
              <p>
                Today, 3SK Chocolates has earned the trust of customers, resellers, and businesses across India through consistent quality, honest pricing, and exceptional service. The appreciation and positive reviews we receive continue to inspire us to innovate, improve, and raise the standards of premium chocolate manufacturing.
              </p>
              <p>
                At 3SK Chocolates, we don't simply make chocolates—we create memorable experiences. Every bite represents our passion for quality, our dedication to affordability, and our promise to deliver luxury without compromise.
              </p>
              <p>
                As we continue to grow, our commitment remains unchanged: to become India's most trusted name in Kunafa Chocolates by combining uncompromising quality, elegant craftsmanship, and the best value in the market.
              </p>
            </div>
      ...
      <section className="py-20 bg-cocoa-card relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-dark-chocolate p-8 rounded border border-gold-900/20 shadow-gold-glow flex flex-col items-center text-center space-y-4 hover:-translate-y-1 transition-transform duration-300">
