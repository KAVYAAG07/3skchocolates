...
export default function Header({ activeTab, setActiveTab }: HeaderProps) {
  ...
  return (
    <header className="sticky top-0 z-50 bg-dark-chocolate/95 backdrop-blur-md border-b border-gold-800/20">
      ...
      {/* Dynamic Ticker / Announcement Bar */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-50">
        <div className="flex justify-between items-center h-24">
          ...
          {/* Brand Logo - Official 3SK Brand Asset Image (Merged with background, borderless & box-free) */}
          <div 
          ...
          {/* Desktop Taskbar Navigation Links */}
          ...
          <div className="flex items-center gap-4 relative">
            ...
            {/* Three Dots Vertical Dropdown Button (Only visible on mobile/tablet) */}
