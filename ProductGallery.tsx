...
export default function ProductGallery({ onOrderClick }: ProductGalleryProps) {
  ...
  const productsData = {
    pistachio: {
      ...
      description: 'The authentic globally-renowned sensation. Inside our glossy, tempered milk chocolate shell lies an abundance of golden toasted, micro-thin shredded kunafa pastry threads folded into 100% pure premium pistachio butter cream.',
    ...
    hazelnut: {
      ...
      description: 'For the lovers of rich, chocolatey hazelnut spreads. We fold our perfectly golden, crispy kunafa pastry threads into a velvety, decadent hazelnut cream, then lock it inside our premium milk chocolate bar. Every bite offers a majestic contrast between the crackle of pastry and the smoothness of hazelnuts.',
          ...
          <div className="lg:col-span-6 bg-cocoa-card rounded-xl p-6 sm:p-8 border border-gold-800/15 shadow-2xl flex flex-col justify-between space-y-8">
            ...
            <div className="pt-6 border-t border-gold-900/10 flex flex-col sm:flex-row items-center justify-between gap-4 bg-dark-chocolate/40 p-4 rounded-lg border border-gold-900/5">
              ...
              <button
                ...
                className="w-full sm:w-auto bg-gradient-to-r from-gold-600 to-gold-500 text-dark-chocolate hover:from-gold-500 hover:to-gold-400 px-6 py-3 rounded text-xs font-bold tracking-widest flex items-center justify-center gap-2 transition-all cursor-pointer shadow-lg hover:shadow-gold-500/20"
              >
